...
import { type Command, type CreateWorkPackageCommand, type AddTaskCommand, type ReportDailyProgressCommand } from './commands/Commands';
import { type DomainEvent, type WorkPackageCreated, type TaskAdded, type DailyProgressReported } from './events/DomainEvents';

export class WorkPackageAggregate extends AggregateRoot<Record<string, never>> {
  name: string;
  tasks: Task[];
