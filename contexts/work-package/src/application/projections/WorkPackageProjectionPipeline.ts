import { type ProjectionSinkPort } from '@shared/patterns';
...
export class WorkPackageProjectionPipeline {
  private readonly sink: ProjectionSinkPort<WorkPackageReadModel>;

  constructor(sink: ProjectionSinkPort<WorkPackageReadModel>) {
    this.sink = sink;
  }
